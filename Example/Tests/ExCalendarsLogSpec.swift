...
class ExCalendarsLogSpec: QuickSpec{
    override func spec() {
        describe("5 weeks related with 2019/05/05 ") {
            ...
            it("Show grid logs"){
                let calendar = try? ExCalendars<String>(markedDate: date, numOfWeeks: 5, startWeek: WeekDay.Sun)
            ...
            it("Show list logs for custom class content"){
                ...
                let calendar = try? ExCalendars<TestA>(markedDate: date, numOfWeeks: 5, startWeek: WeekDay.Sun)
